...
# nn- neural network (has layers like linear, Conv2D, ReLU etc)
# device- tells pytorch where calculations happen, CPU or GPU without this the code will run on CPU
from torch.utils.data import Dataset, DataLoader
# Dataset represents your entire dataset
# DataLoader gives limited data at a time
from torchvision import datasets
# torch vision contains datasets. instead of downloading FashionMNIST yourself.
from torchvision.transforms import v2
# transform modify images like 0,255,128 will become 0.0,1.0,0.502

class NeuralNetwork(nn.Module): # this has every module of neural network required
    def __init__(self):
